...
Alas, all is not lost for anyone that wants to take on GH. There is no disputing, GH has won the war on distribution. The next war is for custody. In this new codegen era, what matters is knowing exactly who, or what, touched a change at every step from prompt to production. Maintaining a chain of custody is the **key unlock** to provenance. This is the thing we were reaching for at Fimio when we SHA'd everything. In this codegen era, provenance is going to matter more than distribution. If you solve provenance, you have a shot at winning.
